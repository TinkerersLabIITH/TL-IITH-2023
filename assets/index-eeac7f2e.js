...
`,u=({words:i,interval:d,typingDelay:r,erasingDelay:p})=>{const[n,s]=a.useState(0),[h,x]=a.useState(""),[A,b]=a.useState(!0);return a.useEffect(()=>{let j;if(A){const g=i[n],y=g.length;j=setInterval(()=>{x(N=>N.length===y?(b(!1),N):g.slice(0,N.length+1))},d)}else j=setInterval(()=>{x(g=>g.length===0?(b(!0),s(y=>(y+1)%i.length),""):g.slice(0,g.length-1))},p);return()=>clearInterval(j)},[n,i,d,r,p,A]),e.jsx("span",{children:h})},J=[{original:"./imagescroll/Imagescroll1.png",thumbnail:"./imagescroll/Imagescroll1.png"},{original:"./imagescroll/imagescroll3.jpg",thumbnail:"./imagescroll/imagescroll3.jpg"},{original:"./imagescroll/imagescroll4.jpg",thumbnail:"./imagescroll/imagescroll4.jpg"},{original:"./imagescroll/imagescroll2.jpg",thumbnail:"./imagescroll/imagescroll2.jpg"},{original:"./imagescroll/imagescroll5.jpg",thumbnail:"./imagescroll/imagescroll5.jpg"},{original:"./imagescroll/imagescroll6.png",thumbnail:"./imagescroll/imagescroll6.png"}];function _(){return e.jsx(Z,{children:e.jsx("div",{className:"contimg",children:e.jsx("div",{className:"imggal",children:e.jsx(D,{showNav:!0,showPlayButton:!1,showFullscreenButton:!1,showThumbnails:!1,items:J})})})})}const Z=c.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
