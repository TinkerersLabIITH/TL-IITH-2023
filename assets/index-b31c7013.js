import{s as l,r,j as e,N as x,C as F,m as i,g as w,S as M,a as O,X as W,H as G,R as B,b as u,c as U,d as V}from"./vendor-9d4d250c.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))m(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&m(h)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function m(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const J=()=>{const[t,a]=r.useState(!1),s=()=>{a(!t)};return e.jsx("div",{className:"nav-container",children:e.jsxs(_,{children:[e.jsx(X,{children:e.jsx("img",{src:"./images/TL_Logo.svg",alt:""})}),e.jsxs(Y,{onClick:s,className:t?"active":"",children:[e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"})]}),e.jsx($,{showMenu:t,className:t?"bg-black active":"",children:e.jsxs(K,{children:[e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/",children:"HOME"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/team",children:"TEAM"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/events",children:"EVENTS"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/inventory",children:"INVENTORY"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/projects",children:"PROJECTS"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/sponsors",children:"SPONSORS"})}),e.jsx(N,{children:e.jsx(x,{onClick:s,to:"/contacts",children:"CONTACT US"})})]})})]})})},_=l.nav`
  display: flex;
  align-items: center;
...
`,A=({words:t,interval:a,typingDelay:s,erasingDelay:m})=>{const[n,o]=r.useState(0),[h,v]=r.useState(""),[k,p]=r.useState(!0);return r.useEffect(()=>{let f;if(k){const g=t[n],y=g.length;f=setInterval(()=>{v(b=>b.length===y?(p(!1),b):g.slice(0,b.length+1))},a)}else f=setInterval(()=>{v(g=>g.length===0?(p(!0),o(y=>(y+1)%t.length),""):g.slice(0,g.length-1))},m);return()=>clearInterval(f)},[n,t,a,s,m,k]),e.jsx("span",{children:h})};l.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,me="/assets/cyberevent-a83abfc2.png",he="/assets/tinkering101ep2-af648a49.png",ge="/assets/tinkering101ep1-6774b441.png",xe="/assets/tinkerersnight-7a7d2eb8.png",pe="/assets/tinkerersnight2024-c4aa0901.png",fe="/assets/orientation-25d75c5e.jpg",ue="/assets/micromouse-62f7404c.png",je="/assets/treasure-4e1c9c54.jpg",ve="/assets/keynote-7c372305.jpg",ye="/assets/workshop-b8d591cc.jpg",be="/assets/thrust-ff25c4ce.jpg",we=()=>{const t=["Think","Tinker","Transform"],n={backgroundImage:`url(${me})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},o={backgroundImage:`url(${pe})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},h={backgroundImage:`url(${ye})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},v={backgroundImage:`url(${be})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},k={backgroundImage:`url(${ve})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},p={backgroundImage:`url(${je})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},f={backgroundImage:`url(${ue})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},g={backgroundImage:`url(${fe})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},y={backgroundImage:`url(${he})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},b={backgroundImage:`url(${ge})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"},I={backgroundImage:`url(${xe})`,transform:"translate3d(0, 0, 0)",position:"relative",width:"100%",backgroundSize:"cover",backgroundPosition:"center",transition:"filter 0.5s ease",aspectRatio:"1.72",borderRadius:"67.5px"};return e.jsxs(Ne,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsx("div",{className:"circle6"}),e.jsx("div",{className:"circle7"}),e.jsx("div",{className:"circle8"}),e.jsx("div",{className:"circle9"}),e.jsx("div",{className:"circle10"}),e.jsx("div",{className:"circle11"}),e.jsx("div",{className:"circle12"}),e.jsx("div",{className:"circle13"}),e.jsx("div",{className:"circle14"}),e.jsx("div",{className:"circle15"}),e.jsx("div",{className:"circle16"}),e.jsx("div",{className:"circle17"}),e.jsxs("div",{className:"container grid grid-two-column",children:[e.jsxs("div",{className:"section-hero-data",children:[e.jsx("h2",{className:"text-white hero-heading",children:"Events"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsxs("h4",{className:"text-white hero-bottom",children:["  ",e.jsx(A,{words:t,interval:200,typingDelay:2e3,erasingDelay:100})]})]}),e.jsx("div",{className:"section-hero-image",children:e.jsx("picture",{children:e.jsx("img",{src:"./images/Event.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"flex-container",children:[e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:v,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"Thrust, the flagship event organized by Tinkerers’ Lab, took place over three exciting days from March 1st to 3rd, 2024. The event was brimming with activities, creating a dynamic and engaging atmosphere for all participants."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name",children:"Thrust 2024"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:h,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"Tinkerers’ Lab hosted workshops and bootcamps covering more than 10 essential topics across various disciplines. Each session, supported by Tinkerers’ Lab, attracted an average audience of over 200 participants."})})}),e.jsxs("div",{className:"Left-Img",children:[e.jsx("div",{className:"image-name",children:"Workshops"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:o,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"Tinkering Night is the annual signature event of Tinkerers’ Lab, where students gather in the lab from approximately 10 PM to 6 AM to work on a project of their choice, striving to complete it successfully by morning."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name",children:"Tinkerers' Night 2024"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:k,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"During the keynote talk, students gained valuable insights into industry requirements and current technologies in use. Bosch initiated negotiations with Tinkerers’ Lab (TL) for several industry-based projects, indicating potential collaborations ahead."})})}),e.jsxs("div",{className:"Left-Img",children:[e.jsx("div",{className:"image-name",children:"Thrust-Keynote Talk"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:p,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"The nighttime treasure hunt captivated students as they navigated through clues to uncover hidden prizes, significantly elevating enthusiasm and participation. Featuring 10 competitive teams, each consisting of 4-5 members, the event amplified excitement and awareness about Thrust among students."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name",children:"Treasure Hunt"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:f,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"As part of the inter-hostel general championship at IIT Hyderabad, Tinkerers’ Lab volunteered to conduct the Micromouse competition with a high level of professionalism. They led the development of multiple micromouse bots in collaboration with the student community."})})}),e.jsxs("div",{className:"Left-Img",children:[e.jsx("div",{className:"image-name",children:"Micromouse"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:g,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"For the Orientation event, Tinkerers’ Lab welcomed new students with an engaging introduction to its facilities and resources. The event provided an overview of various projects and activities, encouraging students to explore their creativity and technical skills. With hands-on demonstrations and interactive sessions, Tinkerers’ Lab successfully inspired enthusiasm and participation among the newcomers."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name",children:"Orientation-2023"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:n,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"For the Cybercon event, Tinkerers’ Lab, in collaboration with the Cyber Security Club Kludge, hosted an engaging cyber conclave. The event featured expert talks, hands-on workshops, and interactive sessions focused on the latest trends and challenges in cybersecurity. Participants gained valuable knowledge and skills, while the collaborative effort successfully fostered a deeper interest and understanding of cybersecurity among students."})})}),e.jsxs("div",{className:"Left-Img",children:[e.jsx("div",{className:"image-name",children:"CyberCon-2023"}),e.jsx("div",{className:"decoration"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:y,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"For the Tinkering Episodes, Tinkerers’ Lab conducted a series of interactive sessions designed to inspire creativity and innovation. Each episode featured expert-led discussions, hands-on activities, and collaborative projects, covering a wide range of topics. These sessions provided students with practical skills and insights, fostering a vibrant learning environment and encouraging continuous exploration and tinkering."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name-2",children:"Tinkering-101-Episode-02"}),e.jsx("div",{className:"decoration-2"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:b,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"For the Tinkering Episodes, Tinkerers’ Lab conducted a series of interactive sessions designed to inspire creativity and innovation. Each episode featured expert-led discussions, hands-on activities, and collaborative projects, covering a wide range of topics. These sessions provided students with practical skills and insights, fostering a vibrant learning environment and encouraging continuous exploration and tinkering."})})}),e.jsxs("div",{className:"Left-Img",children:[e.jsx("div",{className:"image-name-3",children:"Tinkering-101-Episode-01"}),e.jsx("div",{className:"decoration-3"})]})]})}),e.jsx("div",{className:"flex-item",children:e.jsxs("div",{className:"image",children:[e.jsx("div",{className:"Effect",style:I,children:e.jsx("div",{className:"Content",children:e.jsx("p",{children:"For Tinkerers’ Night, Tinkerers’ Lab hosted an immersive overnight event where students gathered from 10 PM to 6 AM to work on projects of their choice. The event featured collaborative problem-solving, expert guidance, and a dynamic atmosphere, allowing participants to bring their ideas to life. Tinkerers’ Night successfully fostered creativity, teamwork, and innovation, making it a memorable and impactful experience for all involved."})})}),e.jsxs("div",{className:"Right-Img",children:[e.jsx("div",{className:"image-name-4",children:"Tinkerers-Night"}),e.jsx("div",{className:"decoration-4"})]})]})})]})]})},Ne=l.section`
  padding: 9rem 0;
...
`,ke=["Think","Tinker","Transform"],Ae=200,Ce=2e3,Ie=100,Te=()=>e.jsxs(Se,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{whileHover:{scale:1.5},className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(i.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Inventory"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(A,{words:ke,interval:Ae,typingDelay:Ce,erasingDelay:Ie})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(i.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Inventory.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"wip",children:[e.jsx("h2",{className:"text-white",children:"Work in Progress"}),e.jsx("picture",{children:e.jsx("img",{src:"./images/wip1.png",alt:"image",className:"hero-img"})})]})]})]}),Se=l.section`
  padding: 9rem 0;
  .col-xl {
    text-align: center;
  }
...
`,De=["Think","Tinker","Transform"],Fe=200,Me=2e3,Oe=100,We=()=>{const[t,a]=r.useState({name:"",email:"",message:"",send:!1}),[s,m]=r.useState({name:!1,email:!1,message:!1,send:!1}),[n,o]=r.useState(!1);function h(c){const{name:d,value:z}=c.target;a(D=>({...D,[d]:z}))}const v=r.useRef(null);function k(c){const d=/(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/;c.preventDefault(),m({name:!t.name,email:!(t.email&&d.test(t.email)),message:!t.message,send:!!(t.name&&t.email&&d.test(t.email)&&t.message)}),t.name&&t.email&&d.test(t.email)&&t.message&&o(!0),setInterval(()=>{p.length<5?f(p+"."):f(".")},1e3),t.name&&t.email&&d.test(t.email)&&t.message&&fetch("https://script.google.com/macros/s/AKfycbweHBn46bB_ikYWUgVWtfV1S-IAB3bxLCA5eV0zHFKaDArWNECVvsr05AESUfj8A-St/exec",{method:"POST",body:new FormData(v.current)}).then(z=>o(!1),a({name:"",email:"",message:"",send:!0}),setTimeout(()=>{a({name:"",email:"",message:"",send:!1})},8e3)).catch(z=>console.log(z))}const[p,f]=r.useState("."),g=e.jsx("div",{className:"section-message-submit",children:e.jsx("button",{children:"Submit"})}),y=e.jsx("div",{className:"section-message-submitting",children:e.jsxs("button",{disabled:!0,children:["Submitting",p]})}),b=e.jsxs("div",{className:"send-confirm",children:[e.jsx("p",{children:"Thanks for filling the form"}),e.jsx("p",{children:"We will reach out to you soon!"})]}),[I,P]=r.useState(E());function E(){return{width:window.innerWidth,height:window.innerHeight}}r.useEffect(()=>{const c=()=>{P(E())};return window.addEventListener("resize",c),()=>{window.removeEventListener("resize",c)}},[I]),w.registerPlugin(M);const T=r.useRef(null),S=r.useRef(null),L=r.useRef(null);return I.width>=1200?r.useEffect(()=>{const c=T.current;w.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"50px 45%",end:"+=1290"}});const d=S.current;w.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"50px 45%",end:"+=1250"}})},[]):I.width<=770?r.useEffect(()=>{const c=T.current;w.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"-55% 50%",end:"+=1280"}});const d=S.current;w.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"-65% 50%",end:"+=1250"}})},[]):r.useEffect(()=>{const c=T.current;w.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"-60% 50%",end:"+=1320"}});const d=S.current;w.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"-60% 50%",end:"+=1300"}})},[]),e.jsxs(Ge,{className:"bg-white",children:[e.jsx("div",{className:"ellipse1"}),e.jsx("div",{className:"ellipse2"}),e.jsx("div",{className:"circle1"}),e.jsx("div",{className:"circle2"}),e.jsx("div",{className:"circle3"}),e.jsx("div",{className:"circle4"}),e.jsx("div",{className:"circle5"}),e.jsxs("div",{className:"container grid grid-two-column",children:[e.jsxs("div",{className:"section-hero-data",children:[e.jsx("h2",{className:"hero-heading",children:"Contact us!"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("div",{className:"hero-bottom",children:e.jsx(A,{words:De,interval:Fe,typingDelay:Me,erasingDelay:Oe})})]}),e.jsx("div",{className:"section-hero-image",children:e.jsx("picture",{children:e.jsx("img",{src:"./images/Contacts.svg",alt:"image",className:"hero-img",ref:L})})})]}),e.jsxs("div",{className:"section-map-message",children:[e.jsx("div",{className:"section-map",ref:S,children:e.jsx("div",{className:"map-iframe",children:e.jsx("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461.1025061004142!2d78.12566068992736!3d17.597490805694715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbf706d15f396d%3A0xd8767eda72322c70!2sTinkerers'%20Laboratory%20IITH!5e0!3m2!1sen!2sin!4v1688018342297!5m2!1sen!2sin",width:"100%",height:"100%",style:{border:0},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})})}),e.jsxs("div",{className:"section-message",ref:T,children:[e.jsx("h4",{children:"Message Us"}),e.jsxs("form",{className:"section-message-box",onSubmit:k,noValidate:!0,ref:v,children:[e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-name",children:"Name"}),e.jsx("input",{type:"text",placeholder:"Enter here",id:"message-name",name:"name",value:t.name,onChange:h})]}),s.name&&e.jsx("div",{className:"message-warning",children:"Enter your name"}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-email",children:"Mail ID"}),e.jsx("input",{type:"email",placeholder:"Enter here",id:"message-email",name:"email",value:t.email,onChange:h}),s.email&&e.jsx("div",{className:"message-warning",children:"Enter your email"})]}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-message",children:"Enter your Message"}),e.jsx("textarea",{placeholder:"Enter here",id:"message-message",name:"message",value:t.message,onChange:h}),s.message&&e.jsx("div",{className:"message-warning",children:"Enter your message"})]}),n?y:g,t.send&&b]})]})]})]})},Ge=l.section`
  padding: 9rem 0;
...
`,Qe=["Think","Tinker","Transform"],R={category:"Title Sponsor",logo:"/sponsors/image 64.png",name:"KC overseas"},Ze=[{category:"Co-Title Sponsors",logo:"/sponsors/Group 249.png",name:"Unistring Tech Solutions"},{category:"Co-Title Sponsors",logo:"/sponsors/Group 253.png",name:"Institution's Innovation Council"},{category:"Gen AI Partner",logo:"/sponsors/Group 248.png",name:"Pathway"},{category:"Gold Sponsor",logo:"/sponsors/Bosch_symbol_logo_black_red 3.png",name:"Bosch"},{category:"Silver Sponsor",logo:"/sponsors/Logo 1.png",name:"Contentstack"},{category:"Silver Sponsor",logo:"/sponsors/Group 317.png",name:"NMDC"},{category:"AutoExpo Partner",logo:"/sponsors/image 64 (1).png",name:"Servo"},{category:"Learning Partners",logo:"/sponsors/image 64 (2).png",name:"QuillBot",link:"https://quillbot.com/ai-humanizer"},{category:"Learning Partners",logo:"/sponsors/Symbolab logo 2.png",name:"Symbolab",link:"http://Symbolab.com"},{category:"Event Partners",logo:"/sponsors/image 65.png",name:"Cubelelo"},{category:"Event Partners",logo:"/sponsors/Silent Logo White 1.png",name:"Silent Owl"},{category:"Event Partners",logo:"/sponsors/WhatsApp Image 2025-03-18 at 21.40.48_be2ef94d 1.png",name:"RoboWars"},{category:"Media Partner",logo:"/sponsors/Group 253 (1).png",name:"BIG TV India"}],j=[{category:"Audio Partner",logo:"/sponsors/WhatsApp Image 2025-03-18 at 21.34.20_abf7ce6b 2.png",name:"HAMMER"},{category:"Travel Partner",logo:"/sponsors/Group 250.png",name:"EaseMyTrip"},{category:"Gaming Partner",logo:"/sponsors/WhatsApp Image 2025-03-19 at 21.17.11_fcc4da9a 1.png",name:"SharePal.in"},{category:"Platform Partner",logo:"/sponsors/Group 308.png",name:"Unstop"}],H=Ze.reduce((t,a)=>(t[a.category]||(t[a.category]=[]),t[a.category].push(a),t),{}),qe=200,ei=2e3,ii=100,ti=()=>e.jsxs(si,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(i.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Sponsors"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers' Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(A,{words:Qe,interval:qe,typingDelay:ei,erasingDelay:ii})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(i.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Sponsorship.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"whole-sponsor",children:[e.jsx("div",{className:"light left-light-1"}),e.jsx("div",{className:"light left-light-2"}),e.jsx("div",{className:"light left-light-3"}),e.jsx("div",{className:"light right-light-1"}),e.jsx("div",{className:"light right-light-2"}),e.jsx("div",{className:"light right-light-3"}),e.jsx("div",{className:"sponsor-title mb-[3rem]",children:R.category}),R&&e.jsx("div",{className:"main-sponsor",children:e.jsx("div",{className:"main-sponsor-card",children:e.jsx("img",{className:"main-sponsor-logo",src:R.logo})})}),Object.keys(H).map((t,a)=>t!=="Title Sponsor"&&e.jsxs("div",{className:"sponsor-category",children:[e.jsx("h4",{className:"category-title",children:t}),e.jsx("div",{className:"sponsorlist",children:H[t].map((s,m)=>e.jsx("div",{className:"sponsor-card",children:s.link?e.jsx("a",{href:s.link,target:"_blank",rel:"noopener noreferrer",className:"sponsor-link",children:e.jsx("img",{className:"sponsor-logo",src:s.logo,alt:s.name})}):e.jsx("img",{className:"sponsor-logo",src:s.logo,alt:s.name})},m))})]},a)),e.jsxs("div",{className:"sponsor-row",children:[e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[0].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[0].logo})})]}),e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[1].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[1].logo})})]})]}),e.jsxs("div",{className:"sponsor-row",children:[e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[2].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[2].logo})})]}),e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[3].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[3].logo})})]})]})]})]})]}),si=l.section`
  padding: 9rem 0;
  overflow: hidden;
  .whole-sponsor {
    position: relative;
...
`;const ai=()=>{const t={colors:{heading:"#001824",text_heading:"#6C10C6",nav_color:"#484848",white:"#fff",gradient:"radial-gradient(40.83% 40.83% at 50% 50%, rgba(108, 16, 198, 0.5) 0%, rgba(186, 104, 200, 0) 100%) ",media:{mobile:"768px",tab:"1127px"}}};return e.jsxs(W,{theme:t,children:[e.jsx(ni,{}),e.jsxs(G,{children:[e.jsx(J,{}),e.jsxs(B,{children:[e.jsx(u,{path:"",element:e.jsx(se,{})}),e.jsx(u,{path:"team",element:e.jsx(ce,{})}),e.jsx(u,{path:"events",element:e.jsx(we,{})}),e.jsx(u,{path:"inventory",element:e.jsx(Te,{})}),e.jsx(u,{path:"projects",element:e.jsx(Pe,{})}),e.jsx(u,{path:"sponsors",element:e.jsx(ti,{})}),e.jsx(u,{path:"contacts",element:e.jsx(We,{})}),e.jsx(u,{path:"workshops",element:e.jsx(Ke,{})})]}),e.jsx(Be,{})]})]})};U.createRoot(document.getElementById("root")).render(e.jsx(V.StrictMode,{children:e.jsx(ai,{})}));
