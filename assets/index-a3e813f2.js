import{s as c,r as a,j as e,N as b,C as S,m as t,g as j,S as L,a as F,X as P,H as D,R as O,b as y,c as M,d as W}from"./vendor-b277aeb1.js";(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))x(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const m of n.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&x(m)}).observe(document,{childList:!0,subtree:!0});function r(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function x(s){if(s.ep)return;s.ep=!0;const n=r(s);fetch(s.href,n)}})();const Y=()=>{const[i,d]=a.useState(!1),r=()=>{d(!i)};return e.jsx("div",{className:"nav-container",children:e.jsxs(U,{children:[e.jsx(G,{children:e.jsx("img",{src:"./images/TL_Logo.svg",alt:""})}),e.jsxs($,{onClick:r,className:i?"active":"",children:[e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"})]}),e.jsx(V,{showMenu:i,className:i?"bg-black active":"",children:e.jsxs(K,{children:[e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/",children:"HOME"})}),e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/team",children:"TEAM"})}),e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/events",children:"EVENTS"})}),e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/inventory",children:"INVENTORY"})}),e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/projects",children:"PROJECTS"})}),e.jsx(N,{children:e.jsx(b,{onClick:r,to:"/contacts",children:"CONTACT US"})})]})})]})})},U=c.nav`
  display: flex;
  align-items: center;
...
`,A=({words:i,interval:d,typingDelay:r,erasingDelay:x})=>{const[s,n]=a.useState(0),[m,f]=a.useState(""),[w,g]=a.useState(!0);return a.useEffect(()=>{let p;if(w){const h=i[s],u=h.length;p=setInterval(()=>{f(v=>v.length===u?(g(!1),v):h.slice(0,v.length+1))},d)}else p=setInterval(()=>{f(h=>h.length===0?(g(!0),n(u=>(u+1)%i.length),""):h.slice(0,h.length-1))},x);return()=>clearInterval(p)},[s,i,d,r,x,w]),e.jsx("span",{children:m})};c.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,be=["Think","Tinker","Transform"],we=200,ye=2e3,Ne=100,ke=()=>e.jsxs(Ae,{children:[e.jsx(t.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(t.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(t.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(t.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(t.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{whileHover:{scale:1.5},className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(t.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Inventory"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(A,{words:be,interval:we,typingDelay:ye,erasingDelay:Ne})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(t.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Inventory.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"wip",children:[e.jsx("h2",{className:"text-white",children:"Work in Progress"}),e.jsx("picture",{children:e.jsx("img",{src:"./images/wip1.png",alt:"image",className:"hero-img"})})]})]})]}),Ae=c.section`
  padding: 9rem 0;
  .col-xl {
    text-align: center;
  }
...
`;const Ye=()=>{const i={colors:{heading:"#001824",text_heading:"#6C10C6",nav_color:"#484848",white:"#fff",gradient:"radial-gradient(40.83% 40.83% at 50% 50%, rgba(108, 16, 198, 0.5) 0%, rgba(186, 104, 200, 0) 100%) ",media:{mobile:"768px",tab:"1127px"}}};return e.jsxs(P,{theme:i,children:[e.jsx(We,{}),e.jsxs(D,{children:[e.jsx(Y,{}),e.jsxs(O,{children:[e.jsx(y,{path:"",element:e.jsx(Q,{})}),e.jsx(y,{path:"team",element:e.jsx(ae,{})}),e.jsx(y,{path:"events",element:e.jsx(ve,{})}),e.jsx(y,{path:"inventory",element:e.jsx(ke,{})}),e.jsx(y,{path:"projects",element:e.jsx(Re,{})}),e.jsx(y,{path:"contacts",element:e.jsx(Pe,{})})]}),e.jsx(Oe,{})]})]})};M.createRoot(document.getElementById("root")).render(e.jsx(W.StrictMode,{children:e.jsx(Ye,{})}));
