import{s as c,r as a,j as e,N as m,I as D,m as t,g as f,S as L,d as F,a as H,b as P,X as M,H as K,R as O,c as w,e as $,f as W}from"./vendor-19737f9c.js";(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))p(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const h of s.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&p(h)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function p(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const V=()=>{const[i,d]=a.useState(!1),o=()=>{d(!i)};return e.jsx("div",{className:"nav-container",children:e.jsxs(Y,{children:[e.jsx(G,{children:e.jsx("img",{src:"./images/LogoNav.svg",alt:""})}),e.jsxs(B,{onClick:o,className:i?"active":"",children:[e.jsx("div",{}),e.jsx("div",{}),e.jsx("div",{})]}),e.jsx(U,{showMenu:i,className:i?"active":"",children:e.jsxs(X,{children:[e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/",children:"Home"})}),e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/team",children:"Team"})}),e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/events",children:"Events"})}),e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/inventory",children:"Inventory"})}),e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/projects",children:"Projects"})}),e.jsx(v,{children:e.jsx(m,{onClick:o,to:"/contacts",children:"Contacts"})})]})})]})})},Y=c.nav`
  display: flex;
  align-items: center;
...
`,u=({words:i,interval:d,typingDelay:o,erasingDelay:p})=>{const[n,s]=a.useState(0),[h,x]=a.useState(""),[I,b]=a.useState(!0);return a.useEffect(()=>{let j;if(I){const g=i[n],y=g.length;j=setInterval(()=>{x(N=>N.length===y?(b(!1),N):g.slice(0,N.length+1))},d)}else j=setInterval(()=>{x(g=>g.length===0?(b(!0),s(y=>(y+1)%i.length),""):g.slice(0,g.length-1))},p);return()=>clearInterval(j)},[n,i,d,o,p,I]),e.jsx("span",{children:h})},J=[{original:"./imagescroll/Imagescroll1.png",thumbnail:"./imagescroll/Imagescroll1.png"},{original:"./imagescroll/Imagescroll3.png",thumbnail:"./imagescroll/Imagescroll3.png"},{original:"./imagescroll/Imagescroll4.png",thumbnail:"./imagescroll/Imagescroll4.png"},{original:"./imagescroll/Imagescroll5.png",thumbnail:"./imagescroll/Imagescroll5.png"},{original:"./imagescroll/Imagescroll2.png",thumbnail:"./imagescroll/Imagescroll2.png"}];function _(){return e.jsx(Z,{children:e.jsx("div",{className:"contimg",children:e.jsx("div",{className:"imggal",children:e.jsx(D,{showNav:!0,showPlayButton:!1,showFullscreenButton:!1,showThumbnails:!1,items:J})})})})}const Z=c.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,Te=["Think","Tinker","Transform"],Ce=200,He=2e3,Se=100,Re=()=>{const[i,d]=a.useState({name:"",email:"",message:"",send:!1}),[o,p]=a.useState({name:!1,email:!1,message:!1,send:!1}),[n,s]=a.useState(!1);function h(r){const{name:l,value:z}=r.target;d(E=>({...E,[l]:z}))}const x=a.useRef(null);function I(r){const l=/(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/;r.preventDefault(),p({name:!i.name,email:!(i.email&&l.test(i.email)),message:!i.message,send:!!(i.name&&i.email&&l.test(i.email)&&i.message)}),i.name&&i.email&&l.test(i.email)&&i.message&&s(!0),setInterval(()=>{b.length<5?j(b+"."):j(".")},1e3),i.name&&i.email&&l.test(i.email)&&i.message&&fetch("https://script.google.com/macros/s/AKfycbweHBn46bB_ikYWUgVWtfV1S-IAB3bxLCA5eV0zHFKaDArWNECVvsr05AESUfj8A-St/exec",{method:"POST",body:new FormData(x.current)}).then(z=>s(!1),d({name:"",email:"",message:"",send:!0}),setTimeout(()=>{d({name:"",email:"",message:"",send:!1})},8e3)).catch(z=>console.log(z))}const[b,j]=a.useState("."),g=e.jsx("div",{className:"section-message-submit",children:e.jsx("button",{children:"Submit"})}),y=e.jsx("div",{className:"section-message-submitting",children:e.jsxs("button",{disabled:!0,children:["Submitting",b]})}),N=e.jsxs("div",{className:"send-confirm",children:[e.jsx("p",{children:"Thanks for filling the form"}),e.jsx("p",{children:"We will reach out to you soon!"})]}),[T,S]=a.useState(C());function C(){return{width:window.innerWidth,height:window.innerHeight}}a.useEffect(()=>{const r=()=>{S(C())};return window.addEventListener("resize",r),()=>{window.removeEventListener("resize",r)}},[T]),f.registerPlugin(L);const A=a.useRef(null),k=a.useRef(null),R=a.useRef(null);return T.width>=1200?a.useEffect(()=>{const r=A.current;f.fromTo(r,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:r,start:"50px 45%",end:"+=1290"}});const l=k.current;f.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"50px 45%",end:"+=1250"}})},[]):T.width<=770?a.useEffect(()=>{const r=A.current;f.fromTo(r,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:r,start:"-55% 50%",end:"+=1280"}});const l=k.current;f.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"-65% 50%",end:"+=1250"}})},[]):a.useEffect(()=>{const r=A.current;f.fromTo(r,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:r,start:"-60% 50%",end:"+=1320"}});const l=k.current;f.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"-60% 50%",end:"+=1300"}})},[]),e.jsxs(Ee,{children:[e.jsx("div",{className:"ellipse1"}),e.jsx("div",{className:"ellipse2"}),e.jsx("div",{className:"circle1"}),e.jsx("div",{className:"circle2"}),e.jsx("div",{className:"circle3"}),e.jsx("div",{className:"circle4"}),e.jsx("div",{className:"circle5"}),e.jsxs("div",{className:"container grid grid-two-column",children:[e.jsxs("div",{className:"section-hero-data",children:[e.jsx("h2",{className:"hero-heading",children:"Contact us!"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("div",{className:"hero-bottom",children:e.jsx(u,{words:Te,interval:Ce,typingDelay:He,erasingDelay:Se})})]}),e.jsx("div",{className:"section-hero-image",children:e.jsx("picture",{children:e.jsx("img",{src:"./images/Contacts.svg",alt:"image",className:"hero-img",ref:R})})})]}),e.jsxs("div",{className:"section-map-message",children:[e.jsx("div",{className:"section-map",ref:k,children:e.jsx("div",{className:"map-iframe",children:e.jsx("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461.1025061004142!2d78.12566068992736!3d17.597490805694715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbf706d15f396d%3A0xd8767eda72322c70!2sTinkerers'%20Laboratory%20IITH!5e0!3m2!1sen!2sin!4v1688018342297!5m2!1sen!2sin",width:"100%",height:"100%",style:{border:0},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})})}),e.jsxs("div",{className:"section-message",ref:A,children:[e.jsx("h4",{children:"Message Us"}),e.jsxs("form",{className:"section-message-box",onSubmit:I,noValidate:!0,ref:x,children:[e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-name",children:"Name"}),e.jsx("input",{type:"text",placeholder:"Enter here",id:"message-name",name:"name",value:i.name,onChange:h})]}),o.name&&e.jsx("div",{className:"message-warning",children:"Enter your name"}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-email",children:"Mail ID"}),e.jsx("input",{type:"email",placeholder:"Enter here",id:"message-email",name:"email",value:i.email,onChange:h}),o.email&&e.jsx("div",{className:"message-warning",children:"Enter your email"})]}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-message",children:"Enter your Message"}),e.jsx("textarea",{placeholder:"Enter here",id:"message-message",name:"message",value:i.message,onChange:h}),o.message&&e.jsx("div",{className:"message-warning",children:"Enter your message"})]}),n?y:g,i.send&&N]})]})]})]})},Ee=c.section`
  padding: 9rem 0;
