import{s as l,r as a,j as e,N as g,C as L,m as i,g as b,S as P,a as F,X as D,H as M,R as O,b as u,c as W,d as B}from"./vendor-b277aeb1.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))h(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const m of r.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&h(m)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function h(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const U=()=>{const[t,o]=a.useState(!1),n=()=>{o(!t)};return e.jsx("div",{className:"nav-container",children:e.jsxs(G,{children:[e.jsx(J,{children:e.jsx("img",{src:"./images/TL_Logo.svg",alt:""})}),e.jsxs(V,{onClick:n,className:t?"active":"",children:[e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"})]}),e.jsx($,{showMenu:t,className:t?"bg-black active":"",children:e.jsxs(X,{children:[e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/",children:"HOME"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/team",children:"TEAM"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/events",children:"EVENTS"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/inventory",children:"INVENTORY"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/projects",children:"PROJECTS"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/sponsors",children:"SPONSORS"})}),e.jsx(w,{children:e.jsx(g,{onClick:n,to:"/contacts",children:"CONTACT US"})})]})})]})})},G=l.nav`
  display: flex;
  align-items: center;
...
`,k=({words:t,interval:o,typingDelay:n,erasingDelay:h})=>{const[s,r]=a.useState(0),[m,j]=a.useState(""),[N,p]=a.useState(!0);return a.useEffect(()=>{let f;if(N){const x=t[s],v=x.length;f=setInterval(()=>{j(y=>y.length===v?(p(!1),y):x.slice(0,y.length+1))},o)}else f=setInterval(()=>{j(x=>x.length===0?(p(!0),r(v=>(v+1)%t.length),""):x.slice(0,x.length-1))},h);return()=>clearInterval(f)},[s,t,o,n,h,N]),e.jsx("span",{children:m})};l.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,Ee=["Think","Tinker","Transform"],Le=200,Pe=2e3,Fe=100,De=()=>{const[t,o]=a.useState({name:"",email:"",message:"",send:!1}),[n,h]=a.useState({name:!1,email:!1,message:!1,send:!1}),[s,r]=a.useState(!1);function m(c){const{name:d,value:S}=c.target;o(E=>({...E,[d]:S}))}const j=a.useRef(null);function N(c){const d=/(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/;c.preventDefault(),h({name:!t.name,email:!(t.email&&d.test(t.email)),message:!t.message,send:!!(t.name&&t.email&&d.test(t.email)&&t.message)}),t.name&&t.email&&d.test(t.email)&&t.message&&r(!0),setInterval(()=>{p.length<5?f(p+"."):f(".")},1e3),t.name&&t.email&&d.test(t.email)&&t.message&&fetch("https://script.google.com/macros/s/AKfycbweHBn46bB_ikYWUgVWtfV1S-IAB3bxLCA5eV0zHFKaDArWNECVvsr05AESUfj8A-St/exec",{method:"POST",body:new FormData(j.current)}).then(S=>r(!1),o({name:"",email:"",message:"",send:!0}),setTimeout(()=>{o({name:"",email:"",message:"",send:!1})},8e3)).catch(S=>console.log(S))}const[p,f]=a.useState("."),x=e.jsx("div",{className:"section-message-submit",children:e.jsx("button",{children:"Submit"})}),v=e.jsx("div",{className:"section-message-submitting",children:e.jsxs("button",{disabled:!0,children:["Submitting",p]})}),y=e.jsxs("div",{className:"send-confirm",children:[e.jsx("p",{children:"Thanks for filling the form"}),e.jsx("p",{children:"We will reach out to you soon!"})]}),[C,R]=a.useState(z());function z(){return{width:window.innerWidth,height:window.innerHeight}}a.useEffect(()=>{const c=()=>{R(z())};return window.addEventListener("resize",c),()=>{window.removeEventListener("resize",c)}},[C]),b.registerPlugin(P);const I=a.useRef(null),T=a.useRef(null),H=a.useRef(null);return C.width>=1200?a.useEffect(()=>{const c=I.current;b.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"50px 45%",end:"+=1290"}});const d=T.current;b.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"50px 45%",end:"+=1250"}})},[]):C.width<=770?a.useEffect(()=>{const c=I.current;b.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"-55% 50%",end:"+=1280"}});const d=T.current;b.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"-65% 50%",end:"+=1250"}})},[]):a.useEffect(()=>{const c=I.current;b.fromTo(c,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:c,start:"-60% 50%",end:"+=1320"}});const d=T.current;b.fromTo(d,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:d,start:"-60% 50%",end:"+=1300"}})},[]),e.jsxs(Me,{className:"bg-white",children:[e.jsx("div",{className:"ellipse1"}),e.jsx("div",{className:"ellipse2"}),e.jsx("div",{className:"circle1"}),e.jsx("div",{className:"circle2"}),e.jsx("div",{className:"circle3"}),e.jsx("div",{className:"circle4"}),e.jsx("div",{className:"circle5"}),e.jsxs("div",{className:"container grid grid-two-column",children:[e.jsxs("div",{className:"section-hero-data",children:[e.jsx("h2",{className:"hero-heading",children:"Contact us!"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("div",{className:"hero-bottom",children:e.jsx(k,{words:Ee,interval:Le,typingDelay:Pe,erasingDelay:Fe})})]}),e.jsx("div",{className:"section-hero-image",children:e.jsx("picture",{children:e.jsx("img",{src:"./images/Contacts.svg",alt:"image",className:"hero-img",ref:H})})})]}),e.jsxs("div",{className:"section-map-message",children:[e.jsx("div",{className:"section-map",ref:T,children:e.jsx("div",{className:"map-iframe",children:e.jsx("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461.1025061004142!2d78.12566068992736!3d17.597490805694715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbf706d15f396d%3A0xd8767eda72322c70!2sTinkerers'%20Laboratory%20IITH!5e0!3m2!1sen!2sin!4v1688018342297!5m2!1sen!2sin",width:"100%",height:"100%",style:{border:0},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})})}),e.jsxs("div",{className:"section-message",ref:I,children:[e.jsx("h4",{children:"Message Us"}),e.jsxs("form",{className:"section-message-box",onSubmit:N,noValidate:!0,ref:j,children:[e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-name",children:"Name"}),e.jsx("input",{type:"text",placeholder:"Enter here",id:"message-name",name:"name",value:t.name,onChange:m})]}),n.name&&e.jsx("div",{className:"message-warning",children:"Enter your name"}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-email",children:"Mail ID"}),e.jsx("input",{type:"email",placeholder:"Enter here",id:"message-email",name:"email",value:t.email,onChange:m}),n.email&&e.jsx("div",{className:"message-warning",children:"Enter your email"})]}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-message",children:"Enter your Message"}),e.jsx("textarea",{placeholder:"Enter here",id:"message-message",name:"message",value:t.message,onChange:m}),n.message&&e.jsx("div",{className:"message-warning",children:"Enter your message"})]}),s?v:x,t.send&&y]})]})]})]})},Me=l.section`
  padding: 9rem 0;
...
`,Ye=["Think","Tinker","Transform"],Ke=200,_e=2e3,Ze=100,Qe=()=>e.jsxs(qe,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{whileHover:{scale:1.5},className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(i.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Sponsors"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(k,{words:Ye,interval:Ke,typingDelay:_e,erasingDelay:Ze})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(i.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Inventory.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"wip",children:[e.jsx("h2",{className:"text-white",children:"Work in Progress"}),e.jsx("picture",{children:e.jsx("img",{src:"./images/wip1.png",alt:"image",className:"hero-img"})})]})]})]}),qe=l.section`
  padding: 9rem 0;
  .col-xl {
    text-align: center;
  }
...
`;const ii=()=>{const t={colors:{heading:"#001824",text_heading:"#6C10C6",nav_color:"#484848",white:"#fff",gradient:"radial-gradient(40.83% 40.83% at 50% 50%, rgba(108, 16, 198, 0.5) 0%, rgba(186, 104, 200, 0) 100%) ",media:{mobile:"768px",tab:"1127px"}}};return e.jsxs(D,{theme:t,children:[e.jsx(ei,{}),e.jsxs(M,{children:[e.jsx(U,{}),e.jsxs(O,{children:[e.jsx(u,{path:"",element:e.jsx(ee,{})}),e.jsx(u,{path:"team",element:e.jsx(re,{})}),e.jsx(u,{path:"events",element:e.jsx(ve,{})}),e.jsx(u,{path:"inventory",element:e.jsx(Ae,{})}),e.jsx(u,{path:"projects",element:e.jsx(Re,{})}),e.jsx(u,{path:"sponsors",element:e.jsx(Qe,{})}),e.jsx(u,{path:"contacts",element:e.jsx(De,{})}),e.jsx(u,{path:"workshops",element:e.jsx(Xe,{})})]}),e.jsx(Oe,{})]})]})};W.createRoot(document.getElementById("root")).render(e.jsx(B.StrictMode,{children:e.jsx(ii,{})}));
