import{s as l,r,j as e,N as x,C as F,m as i,g as w,S as M,a as O,X as W,H as G,R as B,b as u,c as U,d as V}from"./vendor-b277aeb1.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))m(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&m(h)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function m(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const J=()=>{const[t,n]=r.useState(!1),a=()=>{n(!t)};return e.jsx("div",{className:"nav-container",children:e.jsxs(_,{children:[e.jsx(X,{children:e.jsx("img",{src:"./images/TL_Logo.svg",alt:""})}),e.jsxs(Y,{onClick:a,className:t?"active":"",children:[e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"})]}),e.jsx($,{showMenu:t,className:t?"bg-black active":"",children:e.jsxs(K,{children:[e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/",children:"HOME"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/team",children:"TEAM"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/events",children:"EVENTS"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/inventory",children:"INVENTORY"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/projects",children:"PROJECTS"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/sponsors",children:"SPONSORS"})}),e.jsx(N,{children:e.jsx(x,{onClick:a,to:"/contacts",children:"CONTACT US"})})]})})]})})},_=l.nav`
  display: flex;
  align-items: center;
...
`,A=({words:t,interval:n,typingDelay:a,erasingDelay:m})=>{const[s,o]=r.useState(0),[h,v]=r.useState(""),[k,p]=r.useState(!0);return r.useEffect(()=>{let f;if(k){const g=t[s],y=g.length;f=setInterval(()=>{v(b=>b.length===y?(p(!1),b):g.slice(0,b.length+1))},n)}else f=setInterval(()=>{v(g=>g.length===0?(p(!0),o(y=>(y+1)%t.length),""):g.slice(0,g.length-1))},m);return()=>clearInterval(f)},[s,t,n,a,m,k]),e.jsx("span",{children:h})};l.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,Qe=["Think","Tinker","Transform"],R={category:"Title Sponsor",logo:"/sponsors/image 64.png",name:"KC overseas"},Ze=[{category:"Co-Title Sponsors",logo:"/sponsors/Group 249.png",name:"Unistring Tech Solutions"},{category:"Co-Title Sponsors",logo:"/sponsors/Group 253.png",name:"Institution's Innovation Council"},{category:"Gen AI Partner",logo:"/sponsors/Group 248.png",name:"Pathway"},{category:"Gold Sponsor",logo:"/sponsors/Bosch_symbol_logo_black_red 3.png",name:"Bosch"},{category:"Silver Sponsor",logo:"/sponsors/Logo 1.png",name:"Contentstack"},{category:"Silver Sponsor",logo:"/sponsors/Group 317.png",name:"NMDC"},{category:"AutoExpo Partner",logo:"/sponsors/image 64 (1).png",name:"Servo"},{category:"Learning Partners",logo:"/sponsors/image 64 (2).png",name:"QuillBot"},{category:"Learning Partners",logo:"/sponsors/Symbolab logo 2.png",name:"Symbolab"},{category:"Event Partners",logo:"/sponsors/image 65.png",name:"Cubelelo"},{category:"Event Partners",logo:"/sponsors/Silent Logo White 1.png",name:"Silent Owl"},{category:"Event Partners",logo:"/sponsors/WhatsApp Image 2025-03-18 at 21.40.48_be2ef94d 1.png",name:"RoboWars"},{category:"Media Partner",logo:"/sponsors/Group 253 (1).png",name:"BIG TV India"}],j=[{category:"Audio Partner",logo:"/sponsors/WhatsApp Image 2025-03-18 at 21.34.20_abf7ce6b 2.png",name:"HAMMER"},{category:"Travel Partner",logo:"/sponsors/Group 250.png",name:"EaseMyTrip"},{category:"Gaming Partner",logo:"/sponsors/WhatsApp Image 2025-03-19 at 21.17.11_fcc4da9a 1.png",name:"SharePal.in"},{category:"Platform Partner",logo:"/sponsors/Group 308.png",name:"Unstop"}],H=Ze.reduce((t,n)=>(t[n.category]||(t[n.category]=[]),t[n.category].push(n),t),{}),qe=200,ei=2e3,ii=100,ti=()=>e.jsxs(si,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(i.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Sponsors"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers' Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(A,{words:Qe,interval:qe,typingDelay:ei,erasingDelay:ii})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(i.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Sponsorship.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"whole-sponsor",children:[e.jsx("div",{className:"light left-light-1"}),e.jsx("div",{className:"light left-light-2"}),e.jsx("div",{className:"light left-light-3"}),e.jsx("div",{className:"light right-light-1"}),e.jsx("div",{className:"light right-light-2"}),e.jsx("div",{className:"light right-light-3"}),e.jsx("div",{className:"sponsor-title mb-[3rem]",children:R.category}),R&&e.jsx("div",{className:"main-sponsor",children:e.jsx("div",{className:"main-sponsor-card",children:e.jsx("img",{className:"main-sponsor-logo",src:R.logo})})}),Object.keys(H).map((t,n)=>t!=="Title Sponsor"&&e.jsxs("div",{className:"sponsor-category",children:[e.jsx("h4",{className:"category-title",children:t}),e.jsx("div",{className:"sponsorlist",children:H[t].map((a,m)=>e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:a.logo})},m))})]},n)),e.jsxs("div",{className:"sponsor-row",children:[e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[0].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[0].logo})})]}),e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[1].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[1].logo})})]})]}),e.jsxs("div",{className:"sponsor-row",children:[e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[2].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[2].logo})})]}),e.jsxs("div",{className:"sponsor-container",children:[e.jsx("h4",{className:"sponsor-title",children:j[3].category}),e.jsx("div",{className:"sponsor-card",children:e.jsx("img",{className:"sponsor-logo",src:j[3].logo})})]})]})]})]})]}),si=l.section`
  padding: 9rem 0;
  overflow: hidden;
  .whole-sponsor {
    position: relative;
