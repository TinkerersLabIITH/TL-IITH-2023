import{s as c,r as a,j as e,N as j,C as S,m as i,g as w,S as L,a as P,X as O,H as D,R as F,b as y,c as M,d as Y}from"./vendor-b277aeb1.js";(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))x(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const h of n.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&x(h)}).observe(document,{childList:!0,subtree:!0});function r(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function x(s){if(s.ep)return;s.ep=!0;const n=r(s);fetch(s.href,n)}})();const W=()=>{const[t,d]=a.useState(!1),r=()=>{d(!t)};return e.jsx("div",{className:"nav-container",children:e.jsxs(U,{children:[e.jsx(G,{children:e.jsx("img",{src:"./images/TL_Logo.svg",alt:""})}),e.jsxs($,{onClick:r,className:t?"active":"",children:[e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"}),e.jsx("div",{className:"bg-white"})]}),e.jsx(V,{showMenu:t,className:t?"bg-black active":"",children:e.jsxs(K,{children:[e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/",children:"HOME"})}),e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/team",children:"TEAM"})}),e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/events",children:"EVENTS"})}),e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/inventory",children:"INVENTORY"})}),e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/projects",children:"PROJECTS"})}),e.jsx(N,{children:e.jsx(j,{onClick:r,to:"/contacts",children:"CONTACT US"})})]})})]})})},U=c.nav`
  display: flex;
  align-items: center;
...
`,k=({words:t,interval:d,typingDelay:r,erasingDelay:x})=>{const[s,n]=a.useState(0),[h,f]=a.useState(""),[v,g]=a.useState(!0);return a.useEffect(()=>{let p;if(v){const m=t[s],u=m.length;p=setInterval(()=>{f(b=>b.length===u?(g(!1),b):m.slice(0,b.length+1))},d)}else p=setInterval(()=>{f(m=>m.length===0?(g(!0),n(u=>(u+1)%t.length),""):m.slice(0,m.length-1))},x);return()=>clearInterval(p)},[s,t,d,r,x,v]),e.jsx("span",{children:h})};c.section`
  .contimg {
    margin-top: 25rem;
    text-align: center;
...
`,je=["Think","Tinker","Transform"],ve=200,ye=2e3,Ne=100,Ae=()=>e.jsxs(ke,{children:[e.jsx(i.div,{whileHover:{scale:1.5},className:"circle1"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle2"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle3"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle4"}),e.jsx(i.div,{whileHover:{scale:1.5},className:"circle5"}),e.jsxs("div",{whileHover:{scale:1.5},className:"container",children:[e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-xl",id:"left",children:[e.jsx(i.div,{initial:{opacity:0,y:"50%"},animate:{opacity:1,y:0,transition:{duration:.5}},transition:{duration:1},className:"text-white hero-heading",children:"Inventory"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("h4",{className:"text-white hero-bottom",children:e.jsx(k,{words:je,interval:ve,typingDelay:ye,erasingDelay:Ne})})]}),e.jsx("div",{className:"col-xl",id:"right",children:e.jsx("picture",{children:e.jsx(i.img,{initial:{y:"20%",opacity:0,scale:.8},animate:{y:0,opacity:1,scale:1},transition:{duration:1},src:"./images/Inventory.svg",alt:"image",className:"hero-img"})})})]}),e.jsxs("div",{className:"wip",children:[e.jsx("h2",{className:"text-white",children:"Work in Progress"}),e.jsx("picture",{children:e.jsx("img",{src:"./images/wip1.png",alt:"image",className:"hero-img"})})]})]})]}),ke=c.section`
  padding: 9rem 0;
  .col-xl {
    text-align: center;
  }
...
`,He=["Think","Tinker","Transform"],Se=200,Le=2e3,Pe=100,Oe=()=>{const[t,d]=a.useState({name:"",email:"",message:"",send:!1}),[r,x]=a.useState({name:!1,email:!1,message:!1,send:!1}),[s,n]=a.useState(!1);function h(o){const{name:l,value:C}=o.target;d(H=>({...H,[l]:C}))}const f=a.useRef(null);function v(o){const l=/(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))/;o.preventDefault(),x({name:!t.name,email:!(t.email&&l.test(t.email)),message:!t.message,send:!!(t.name&&t.email&&l.test(t.email)&&t.message)}),t.name&&t.email&&l.test(t.email)&&t.message&&n(!0),setInterval(()=>{g.length<5?p(g+"."):p(".")},1e3),t.name&&t.email&&l.test(t.email)&&t.message&&fetch("https://script.google.com/macros/s/AKfycbweHBn46bB_ikYWUgVWtfV1S-IAB3bxLCA5eV0zHFKaDArWNECVvsr05AESUfj8A-St/exec",{method:"POST",body:new FormData(f.current)}).then(C=>n(!1),d({name:"",email:"",message:"",send:!0}),setTimeout(()=>{d({name:"",email:"",message:"",send:!1})},8e3)).catch(C=>console.log(C))}const[g,p]=a.useState("."),m=e.jsx("div",{className:"section-message-submit",children:e.jsx("button",{children:"Submit"})}),u=e.jsx("div",{className:"section-message-submitting",children:e.jsxs("button",{disabled:!0,children:["Submitting",g]})}),b=e.jsxs("div",{className:"send-confirm",children:[e.jsx("p",{children:"Thanks for filling the form"}),e.jsx("p",{children:"We will reach out to you soon!"})]}),[A,z]=a.useState(T());function T(){return{width:window.innerWidth,height:window.innerHeight}}a.useEffect(()=>{const o=()=>{z(T())};return window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}},[A]),w.registerPlugin(L);const I=a.useRef(null),R=a.useRef(null),E=a.useRef(null);return A.width>=1200?a.useEffect(()=>{const o=I.current;w.fromTo(o,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:o,start:"50px 45%",end:"+=1290"}});const l=R.current;w.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"50px 45%",end:"+=1250"}})},[]):A.width<=770?a.useEffect(()=>{const o=I.current;w.fromTo(o,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:o,start:"-55% 50%",end:"+=1280"}});const l=R.current;w.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"-65% 50%",end:"+=1250"}})},[]):a.useEffect(()=>{const o=I.current;w.fromTo(o,{autoAlpha:0,translateX:"10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:o,start:"-60% 50%",end:"+=1320"}});const l=R.current;w.fromTo(l,{autoAlpha:0,translateX:"-10%"},{autoAlpha:1,translateX:"0",duration:2,scrollTrigger:{trigger:l,start:"-60% 50%",end:"+=1300"}})},[]),e.jsxs(De,{className:"bg-white",children:[e.jsx("div",{className:"ellipse1"}),e.jsx("div",{className:"ellipse2"}),e.jsx("div",{className:"circle1"}),e.jsx("div",{className:"circle2"}),e.jsx("div",{className:"circle3"}),e.jsx("div",{className:"circle4"}),e.jsx("div",{className:"circle5"}),e.jsxs("div",{className:"container grid grid-two-column",children:[e.jsxs("div",{className:"section-hero-data",children:[e.jsx("h2",{className:"hero-heading",children:"Contact us!"}),e.jsx("h3",{className:"hero-tag",children:"Tinkerers’ Lab IITH"}),e.jsx("div",{className:"hero-bottom",children:e.jsx(k,{words:He,interval:Se,typingDelay:Le,erasingDelay:Pe})})]}),e.jsx("div",{className:"section-hero-image",children:e.jsx("picture",{children:e.jsx("img",{src:"./images/Contacts.svg",alt:"image",className:"hero-img",ref:E})})})]}),e.jsxs("div",{className:"section-map-message",children:[e.jsx("div",{className:"section-map",ref:R,children:e.jsx("div",{className:"map-iframe",children:e.jsx("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461.1025061004142!2d78.12566068992736!3d17.597490805694715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbf706d15f396d%3A0xd8767eda72322c70!2sTinkerers'%20Laboratory%20IITH!5e0!3m2!1sen!2sin!4v1688018342297!5m2!1sen!2sin",width:"100%",height:"100%",style:{border:0},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade"})})}),e.jsxs("div",{className:"section-message",ref:I,children:[e.jsx("h4",{children:"Message Us"}),e.jsxs("form",{className:"section-message-box",onSubmit:v,noValidate:!0,ref:f,children:[e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-name",children:"Name"}),e.jsx("input",{type:"text",placeholder:"Enter here",id:"message-name",name:"name",value:t.name,onChange:h})]}),r.name&&e.jsx("div",{className:"message-warning",children:"Enter your name"}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-email",children:"Mail ID"}),e.jsx("input",{type:"email",placeholder:"Enter here",id:"message-email",name:"email",value:t.email,onChange:h}),r.email&&e.jsx("div",{className:"message-warning",children:"Enter your email"})]}),e.jsxs("div",{className:"section-message-box-wraps",children:[e.jsx("label",{htmlFor:"message-message",children:"Enter your Message"}),e.jsx("textarea",{placeholder:"Enter here",id:"message-message",name:"message",value:t.message,onChange:h}),r.message&&e.jsx("div",{className:"message-warning",children:"Enter your message"})]}),s?u:m,t.send&&b]})]})]})]})},De=c.section`
  padding: 9rem 0;
...
`;const We=()=>{const t={colors:{heading:"#001824",text_heading:"#6C10C6",nav_color:"#484848",white:"#fff",gradient:"radial-gradient(40.83% 40.83% at 50% 50%, rgba(108, 16, 198, 0.5) 0%, rgba(186, 104, 200, 0) 100%) ",media:{mobile:"768px",tab:"1127px"}}};return e.jsxs(O,{theme:t,children:[e.jsx(Ye,{}),e.jsxs(D,{children:[e.jsx(W,{}),e.jsxs(F,{children:[e.jsx(y,{path:"",element:e.jsx(Q,{})}),e.jsx(y,{path:"team",element:e.jsx(ae,{})}),e.jsx(y,{path:"events",element:e.jsx(be,{})}),e.jsx(y,{path:"inventory",element:e.jsx(Ae,{})}),e.jsx(y,{path:"projects",element:e.jsx(ze,{})}),e.jsx(y,{path:"contacts",element:e.jsx(Oe,{})})]}),e.jsx(Fe,{})]})]})};M.createRoot(document.getElementById("root")).render(e.jsx(Y.StrictMode,{children:e.jsx(We,{})}));
